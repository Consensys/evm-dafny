...
public class PrecompiledTests {
    private static Precompiles.Bundle bundle = new Precompiles.Bundle();
    // ==============================================================
    // Blake2bf
    // ==============================================================
//
...
//            bundle.toLittleEndianBytes(i, 0, bytes);
//            assertEquals(i,bundle.fromLittleEndian64(bytes, 0));
//        }
//    }
...
//      bytes[4] = 1;
    ...
    public void test_blake_01() {
        ...
        assertArrayEquals(output,bundle.blake2f(input));
    }
